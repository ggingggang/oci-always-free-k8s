...
`renewBefore: 360h` (15일). LE 표준 만료 90일 기준 75% 시점에 자동 갱신 시도. 실패 시 cert-manager가 backoff 재시도. Alertmanager에서 `certmanager_certificate_expiration_timestamp_seconds`를 임계치(7일 등) 감시 권장 (Phase 4).
